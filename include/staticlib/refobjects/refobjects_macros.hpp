...
#define REFOBJ_FORWARD_ARGS_PASS(r, data, i, elem) (p##i)
...
#define REFOBJ_FORWARD_FUNCTION(...) REFOBJ_FORWARD_GET_FUNCTION_MACRO(__VA_ARGS__, REFOBJ_FORWARD_FUNCTION_ARG, REFOBJ_FORWARD_FUNCTION_NOARG, _dummy)(__VA_ARGS__)

#define REFOBJ_FORWARD_GET_FUNCTION_CONST_MACRO(_1,_2,_3,_4,NAME,...) NAME
#define REFOBJ_FORWARD_FUNCTION_CONST(...) REFOBJ_FORWARD_GET_FUNCTION_CONST_MACRO(__VA_ARGS__, REFOBJ_FORWARD_FUNCTION_ARG_CONST, REFOBJ_FORWARD_FUNCTION_NOARG_CONST, _dummy)(__VA_ARGS__)

#define REFOBJ_FORWARD_GET_CONSTRUCTOR_MACRO(_1,_2,NAME,...) NAME
#define REFOBJ_FORWARD_CONSTRUCTOR(...) REFOBJ_FORWARD_GET_CONSTRUCTOR_MACRO(__VA_ARGS__, REFOBJ_FORWARD_CONSTRUCTOR_ARG, REFOBJ_FORWARD_CONSTRUCTOR_NOARG, _dummy)(__VA_ARGS__)

#define REFOBJ_FORWARD_GET_CONSTRUCTOR_REFCOUNT_MACRO(_1,_2,NAME,...) NAME
#define REFOBJ_FORWARD_CONSTRUCTOR_REFCOUNT(...) REFOBJ_FORWARD_GET_CONSTRUCTOR_REFCOUNT_MACRO(__VA_ARGS__, REFOBJ_FORWARD_CONSTRUCTOR_REFCOUNT_ARG, REFOBJ_FORWARD_CONSTRUCTOR_REFCOUNT_NOARG, _dummy)(__VA_ARGS__)
